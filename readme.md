...
This theme is designed to work for statusglo.com and supply the needs of that website, but if you'd like to use it the instructions are below.
...
- **Minification.** Complete with webpack's native features and CSSNano, this gets your CSS and JS files as minified as possible for production build.
...
$ git clone https://github.com/Myzwer/Status-Glo.git
